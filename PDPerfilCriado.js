...
const PDPerfilCriado = () => {
  const navigation = useNavigation();

  return (
    <ScrollView style={styles.pdPerfilcriado}>
      <View style={styles.pdPerfilcriadoChild} />
      ...
      <View style={[styles.home, styles.homeLayout]}>
        <View style={[styles.icons8Confete100, styles.homeLayout]} />
        <Text style={[styles.parabnsVocCompletouContainer, styles.timeTypo]}>
          <Text style={styles.parabnsVocCompletouO}>{`Parabéns!
Você completou o cadastro!
Bem-Vindo(a) ao Diaristas`}</Text>
          <Text style={styles.j}>Já</Text>
        </Text>
      </View>
      <Image
...
const styles = StyleSheet.create({
  ...
  parabnsVocCompletouO: {
    color: Color.colorRoyalblue,
  },
  j: {
    color: Color.colorDarkslateblue,
  },
  parabnsVocCompletouContainer: {
    top: 436,
    left: 17,
    fontSize: 23,

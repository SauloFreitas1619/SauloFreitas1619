...
const PDContratanteEncontrado1 = () => {
  ...
  return (
    <ScrollView style={styles.pdContratanteencontrado}>
      ...
      <View style={[styles.home, styles.homeLayout]}>
        ...
        <Text style={[styles.encontramos1Contratante, styles.timeTypo]}>
          Encontramos 1 contratante correspondente!
        </Text>
      </View>
      <Image
...
export default PDContratanteEncontrado1;

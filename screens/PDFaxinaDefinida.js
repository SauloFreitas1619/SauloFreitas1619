...
const PDFaxinaDefinida = () => {
  const navigation = useNavigation();

  return (
    <ScrollView style={styles.pdFaxinadefinida}>
      <View style={styles.pdFaxinadefinidaChild} />
      ...
      <View style={[styles.home, styles.homeLayout]}>
        ...
        <Text style={[styles.faxinaDefinida, styles.timeTypo]}>
          Faxina Definida!
        </Text>
      </View>
      <Image
...
export default PDFaxinaDefinida;
